...
|---|---:|---:|
| Overall | 86.2% — baseline ran, but no comparable score was available; uplift unavailable | 86.5% — baseline ran, but no comparable score was available; uplift unavailable |
| Security | 100.0% → 100.0% (±0.0 points) | 100.0% → 50.0% (-50.0 points) |
| Correctness | 60.0% → 100.0% (+40.0 points) | 100.0% → 100.0% (±0.0 points) |
...
| Effectiveness | 77.9% → 57.9% (-20.0 points) | 62.9% → 100.0% (+37.1 points) |
| Efficiency | 73.1% — baseline ran, but no comparable score was available; uplift unavailable | 87.7% — baseline ran, but no comparable score was available; uplift unavailable |
...
|---|---|---:|---:|---:|---:|---|
| claude-code | All cases | 416,864 | 710,498 | -293,634 | -41.33% | skill 1/1; base 1/1 |
| claude-code | 1 | 416,864 | 710,498 | -293,634 | -41.33% | skill 1/1; base 1/1 |
| codex | All cases | 126,066 | 121,616 | +4,450 | +3.66% | skill 1/1; base 1/1 |
| codex | 1 | 126,066 | 121,616 | +4,450 | +3.66% | skill 1/1; base 1/1 |
| ALL AGENTS | Dataset aggregate | 542,930 | 832,114 | -289,184 | -34.75% | skill 2/2; base 2/2 |
