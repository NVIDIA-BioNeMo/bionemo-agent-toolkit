...
| **ZAO** | 4D molecular foundation model (multi-conformer 3D) for property/activity prediction and virtual screening. Generates 2048-dim embeddings via a subscribed AWS Marketplace endpoint; ranks #1 on several TDC ADMET datasets with a downstream CatBoost model. | [`zao-embed`](open-models-skills/zao/skills/zao-embed), [`zao-predict`](open-models-skills/zao/skills/zao-predict) |
