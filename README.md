...
| **BioNeMo NIM pipelines** | Multi-NIM compositions: generate → dock → score affinity, and align → predict structure. | [`drug-discovery-pipeline`](nim-skills/meta-skills/drug-discovery-pipeline), [`msa-structure-prediction-pipeline`](nim-skills/meta-skills/msa-structure-prediction-pipeline) |
...
| **Parabricks** | GPU-accelerated genomics — pbrun command guidance and workflow acceleration. | [`parabricks`](library-skills/parabricks), [`genomics-workflow-acceleration`](library-skills/genomics-workflow-acceleration) |
